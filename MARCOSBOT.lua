...
echo -e "\033[0;00m"
echo -e "\e[36m"
./tg -s ./MARCOSBOT.lua -p PROFILE --bot=$token
done
]])  
file:close()  
file = io.open("MS", "w")  
...
__ℳ_________🦅________MARCOSBOT_V2_𝕋𝕖𝔸𝕞_🦅_________ᔕ ____
...
local MARCOSBOT_Msg = ''  
if msgs < 100 then 
MARCOSBOT_Msg = 'غير متفاعل😔💔' 
elseif msgs < 200 then 
MARCOSBOT_Msg = 'بده يتحسن😕💔' 
elseif msgs < 400 then 
MARCOSBOT_Msg = 'شبه متفاعل😗👻' 
elseif msgs < 700 then 
MARCOSBOT_Msg = 'متفاعل😍🙊' 
elseif msgs < 1200 then 
MARCOSBOT_Msg = 'متفاعل قوي😍✔️' 
elseif msgs < 2000 then 
MARCOSBOT_Msg = 'متفاعل جدا😍💘' 
elseif msgs < 3500 then 
MARCOSBOT_Msg = 'اقوى تفاعل🙊👻'  
elseif msgs < 4000 then 
MARCOSBOT_Msg = 'متفاعل نار😍🔥' 
elseif msgs < 4500 then 
MARCOSBOT_Msg = 'قمة التفاعل🤸‍♂️😻' 
elseif msgs < 5500 then 
MARCOSBOT_Msg = 'اقوى متفاعل😳😻' 
elseif msgs < 7000 then 
MARCOSBOT_Msg = 'ملك التفاعل🤴😍' 
elseif msgs < 9500 then 
MARCOSBOT_Msg = 'امبروطور التفاعل💂‍♀️😻' 
elseif msgs < 10000000000 then 
MARCOSBOT_Msg = 'رب التفاعل✔️😍'  
end 
return MARCOSBOT_Msg 
end
...
--------------------------------------------------------------------------------------------------------------
function SourceMARCOSBOT(msg,data) -- بداية العمل
if msg then
...
send(msg.chat_id_, msg.id_,MARCOSBOT_Msg) 
return false  
end 
if text then    
...
if text == 'معلومات السيرفر 📊' and SudoBot(msg) then 
 local text2 = 'Info Server : \n'
  local MARCOSBOT1 = database:info()
  text2 = text2..'1 - *Uptime Days* : `'..MARCOSBOT1.server.uptime_in_days..'('..MARCOSBOT1.server.uptime_in_seconds..' seconds)`\n'
  text2 = text2..'2 - *Commands Processed* : `'..MARCOSBOT1.stats.total_commands_processed..'`\n'
  text2 = text2..'3 - *Expired Keys* : `'..MARCOSBOT1.stats.expired_keys..'`\n'
  text2 = text2..'4 - *Ops/sec* : `'..MARCOSBOT1.stats.instantaneous_ops_per_sec..'`\n'
...
os.execute('rm -rf MARCOSBOT.lua')
os.execute('wget https://raw.githubusercontent.com/MARCOSBOTTEA/MARCOSBOT/master/MARCOSBOT.lua')
send(msg.chat_id_, msg.id_,'🔭| تم تحديث البوت \n📮| لديك اخر اصدار سورس ماركوس\n📡| الاصدار ← { 1.2v}')
dofile('MARCOSBOT.lua')  
end
...
send(msg.chat_id_, msg.id_,'📌¦ عدد المجموعات الان » { '..#group..' }'..MARCOSBOTk..''..MARCOSBOT..'\n*📌| الان عدد المجموعات الحقيقي » { '..sendok..' } مجموعات\n')   
end
end
end,nil)
end
...
--------------------------------------------------------------------------------------------------------------
if MARCOSBOT_Msg and not Special(msg) then  
local MARCOSBOT_Msg = database:get(bot_id.."Add:Filter:Rp2"..text..msg.chat_id_)   
if MARCOSBOT_Msg then    
tdcli_function ({ID = "GetUser",user_id_ = msg.sender_user_id_},function(arg,data) 
...
os.execute('rm -rf MARCOSBOT.lua')
os.execute('wget https://raw.githubusercontent.com/MARCOSBOTBOT1/MARCOSBOTBOT/master/MARCOSBOT.lua')
send(msg.chat_id_, msg.id_,'🔭| تم تحديث البوت \n📮| لديك اخر اصدار سورس ماركوس\n📡| الاصدار ← { 1.2v}')
dofile('MARCOSBOT.lua')  
end
...
👮‍♂️┇[مطور السورس الاول](t.me/RA0AD)

👮‍♂️┇[مطور السورس ثاني](t.me/Mi_20)

🔖┇[كليشه التنصيب](https://t.me/THE_M3RK/6754)
...
if SudoBot(msg) then
local Get_Files, res = https.request("https://raw.githubusercontent.com/MARCOSBOTBOT1/Files_MARCOSBOT/master/getfile.json")
if res == 200 then
...
local json_file, res = https.request("https://raw.githubusercontent.com/MARCOSBOTBOT1/Files_MARCOSBOT/master/File_Bot/"..file)
if res == 200 then
os.execute("rm -fr File_Bot/"..file)
send(msg.chat_id_, msg.id_,t) 
dofile('MARCOSBOT.lua')  
else
send(msg.chat_id_, msg.id_,"⚠️| عذرا هاذا ملف ليس من ملفات سورس ماركوس\n") 
end
return false
end
...
' }\n'..'📮| الايدي بالصوره ← { '..idph..
' }\n'..'📮| الرفع ← { '..setadd..
' }\n'..'📮| الحظر ← { '..banm..' }\n\n┉  ┉  ┉  ┉ ┉  ┉  ┉  ┉  ┉  ┉\n🔖| CH » [Channel MARCOSBOT 🦅](https://t.me/THE_M3RK)\n'
send(msg.chat_id_, msg.id_,text)     
end    
...
t = "\n🔘| قائمة المنع \nء━━━━━━━━━━━━\n"
for k,v in pairs(list) do  
local MARCOSBOT_Msg = database:get(bot_id.."Add:Filter:Rp2"..v..msg.chat_id_)   
t = t..''..k..'- '..v..' » {'..MARCOSBOT_Msg..'}\n'    
end  
if #list == 0 then  
...
send(msg.chat_id_, msg.id_,'['..MARCOSBOT_Msg[math.random(#MARCOSBOT_Msg)]..']') 
return false
end
...
},function(ta,MARCOSBOT)
local t = "\n🔘| قائمة الاعضاء \nء━━━━━━━━━━━━\n"
x = 0
local list = MARCOSBOT.members_
for k, v in pairs(list) do
x = x + 1
...
🔖| م8 » اوامر الاعضاء
ء━━━━━━━━━━━━━━
📮| [Channel MARCOSBOT 🦅](t.me/THE_M3RK)
]]
...
MARCOSBOT = https.request("https://api.telegram.org/bot"..token.."/kickChatMember?chat_id="..msg.chat_id_.."&user_id="..mem_id[i].id_)
local Json_Info = JSON.decode(MARCOSBOT)
...
--------------------------------------------------------------------------------------------------------------
SourceMARCOSBOT(data.message_,data)
...
------------------------------------------------------------------------
local MARCOSBOTbot = database:get(bot_id.."Add:Filter:Rp2"..text..result.chat_id_)   
if MARCOSBOTbot then    
tdcli_function ({ID = "GetUser",user_id_ = result.sender_user_id_},function(arg,data) 
if data.username_ ~= false then
send(msg.chat_id_,0,"⚠¦العضو : {["..data.first_name_.."](T.ME/"..data.username_..")}\n📛¦["..MARCOSBOTbot.."] \n") 
else
