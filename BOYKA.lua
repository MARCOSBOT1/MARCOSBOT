...
------------------------------------------------------------------------
if text == "مسح ردود الميديا"and Manager(msg) then
local list = database:smembers(bot_id.."md:rprd"..msg.chat_id_)
for k,v in pairs(list) do
database:del(bot_id.."keko:addard"..msg.sender_user_id_..msg.chat_id_)
database:del(bot_id.."keko:gifrd"..v..msg.chat_id_)
database:del(bot_id.."keko:vord"..v..msg.chat_id_)
database:del(bot_id.."keko:strd"..v..msg.chat_id_)
database:srem(bot_id.."md:rprd"..msg.chat_id_,v)
  end
 send(msg.chat_id_, msg.id_, "• تم مسح ردود الميديا 🗑", 1, 'md')
    end
if  text == "ردود الميديا" and Manager(msg) then
    local list = database:smembers(bot_id.."md:rprd"..msg.chat_id_)
    text = "🔘| قائمة ردود الميديا ،\n┉ ┉ ┉ ┉ ┉ ┉ ┉ ┉ ┉ \n"
    for k,v in pairs(list) do
  text = text.."*|"..k.."|*~⪼("..v..")\n"
   if #text > 7000 then
    send(msg.chat_id_, msg.id_, text, 'md')
 text = ""
 end
    end
    if #list == 0 then
...
if (text and text == 'اضف رد ميديا' and Manager(msg) ) then 
  send(msg.chat_id_, msg.id_, '📌| الان ارسل الكلمه', 1, 'md')
database:set(bot_id.."keko:addard"..msg.sender_user_id_..msg.chat_id_,"yes")
  return false
end  
if text then 
local keko = database:get(bot_id.."keko:addard"..msg.sender_user_id_..msg.chat_id_)
if keko == 'yes' then 
  send(msg.chat_id_, msg.id_, "📥| الان ارسل الميديا \n 🔰| كمثال (متحركه،بصمه،ملصق)", 1, 'md')
database:set(bot_id.."keko:addard"..msg.sender_user_id_..msg.chat_id_,"yes2")
database:set(bot_id.."keko:add2rd"..msg.sender_user_id_..msg.chat_id_, text)
database:sadd(bot_id.."md:rprd"..msg.chat_id_,text)
return false
end
end
...
local keko = database:get(bot_id.."keko:addard"..msg.sender_user_id_..msg.chat_id_)
if keko == 'yes2' then
send(msg.chat_id_, msg.id_, "🔖| تم الحفظ الرد", 1, 'md')
database:del(bot_id.."keko:addard"..msg.sender_user_id_..msg.chat_id_)
local keko = database:get(bot_id.."keko:add2rd"..msg.sender_user_id_..msg.chat_id_)
if data.message_.content_.sticker_ then 
database:set(bot_id.."keko:strd"..keko..msg.chat_id_, data.message_.content_.sticker_.sticker_.persistent_id_)
  end 
  if data.message_.content_.voice_ then
  database:set(bot_id.."keko:vord"..keko..msg.chat_id_, data.message_.content_.voice_.voice_.persistent_id_)
  end 
  if data.message_.content_.animation_ then 
database:set(bot_id.."keko:gifrd"..keko..msg.chat_id_, data.message_.content_.animation_.animation_.persistent_id_)
end
database:del(bot_id.."keko:add2rd"..msg.sender_user_id_..msg.chat_id_)
  return false
  end
  end
    if (text and text == 'حذف رد ميديا' and  Manager(msg) ) then 
      send(msg.chat_id_, msg.id_, '📬| الان ارسل الكلمه', 1, 'md')
database:set(bot_id.."keko:addard"..msg.sender_user_id_..msg.chat_id_,"yes3")
return false
end
if text then
local keko = database:get(bot_id.."keko:addard"..msg.sender_user_id_..msg.chat_id_)
if (keko and keko == 'yes3') then 
send(msg.chat_id_, msg.id_, "🔘| تم الحذف الرد", 1, 'md')
database:del(bot_id.."keko:addard"..msg.sender_user_id_..msg.chat_id_)
database:del(bot_id.."keko:gifrd"..text..msg.chat_id_)
database:del(bot_id.."keko:vord"..text..msg.chat_id_)
database:del(bot_id.."keko:strd"..text..msg.chat_id_)
database:srem(bot_id.."md:rprd"..msg.chat_id_,text)
return false
end
end
if text and msg.reply_to_message_id_ ~= 0 then
local gif = database:get(bot_id.."keko:gifrd"..text..msg.chat_id_)
local vo = database:get(bot_id.."keko:vord"..text..msg.chat_id_)
local st = database:get(bot_id.."keko:strd"..text..msg.chat_id_)  
