...
t = "\27[35m".."\nAll Files Started : \nHello dear this thing does not belong to you to enter if your mother gives birth\n____________________\n"..'\27[m'
i = 0
...
send(msg.chat_id_,0, "⌯︙عذرا » {["..data.first_name_.."](T.ME/THE_M3RK)}\n⌯︙عذرا تم منع الملصق \n" ) 
end
end,nil)   
DeleteMessage(msg.chat_id_,{[0] = msg.id_})       
return false   
...
if text == 'مطور السورس' or text == 'منو مطور السورس' or text 'هذا مطور السورس' then
Text = [[
👲🏻︙↬[RAAD MARCOS](t.me/Ra_m9)
]]
send(msg.chat_id_, msg.id_,Text)
return false
end
...
send(msg.chat_id_, msg.id_,"⌯︙عذرا الملف لايدعم سورس ماركوس \n") 
end
return false
end
...
tdcli_function ({ID = "GetUser",user_id_ = userid},function(arg,data) 
if data.first_name_ then
usertext = '\n⌯︙لعضو » ['..data.first_name_..'](t.me/'..(data.username_ or 'THE_M3RK')..')'
status  = '\n⌯︙تم تنزيله من المميزين'
send(msg.chat_id_, msg.id_, usertext..status)
else
usertext = '\n⌯︙العضو » '..userid..''
...
-------------------------------
if text == ""..(database:get(bot_id..'Name:Bot') or 'ماركوس').." غادر" or text == 'بوت غادر' then  
