...
'/nطم طم طح طح 😹😹😹طم طم طح طح 😹😹😹
دكو ركبه هزو الخصر خلونا نركص ونغني للفجر',
'/nايامي وياها👫اتمنا انساها😔
...
send(msg.chat_id_, msg.id_,'['..ASTORH_Msg[math.random(#ASTORA_Msg)]..']') 
return false
end
--------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------
