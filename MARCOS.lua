...
dofile('MARCOS.lua')  
os.execute('rm -rf games.lua')
os.execute('wget https://raw.githubusercontent.com/MARCOSBOT1/Files_MARCOS/master/File_Bot/games.lua')
dofile('games.lua')  
os.execute('rm -rf Reply.lua')
os.execute('wget https://raw.githubusercontent.com/MARCOSBOT1/Files_MARCOS/master/File_Bot/Reply.lua')
dofile('Reply.lua')  
end
