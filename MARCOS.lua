...
if Add𝐂𝐡𝐚𝐚𝐧𝐞𝐥(msg.sender_user_id_) == false then
local textchuser = database:get(bot_id..'text:ch:user')
if textchuser then
send(msg.chat_id_, msg.id_,'['..textchuser..']')
else
...
"\n♥️شفت بيك العشگ غافي♥️ \n♥️وشفت بيك النفس دافي ♥️\n♥️وعشگتك من گلب ولسان ♥️\n♥️عشگ ماي وعشگ عطشان♥️\n♥️وعشگ سباح للغرگان♥️\n♥️وعشگ خبزه بحلگ جوعان♥️\n♥️وعشگ فقره بزمن طغيان♥️",
"\n💃💃لا تظربني لا تظرب 💃💃\n💃💃كسرت الخيزارانه💃💃\n💃💃صارلي سنه وست اشهر💃💃\n💃💃من ظربتك وجعانه💃💃",
...
if text == 'قناة تحديثات السورس' or text == 'تحديثات السورس' or text == 'قناة السورس' then
send(msg.chat_id_, msg.id_, '⌯┇ [قناة تحديثات السورس 🎗](t.me/THE_M2RK)')
end
--------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------
